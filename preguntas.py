...
preguntas_avanzadas = {
    ...
    'pregunta_2': {'enunciado':['Luego de su retiro como faraon, Ra dios del Sol, se enfrenta cada noche a una bestia de la mitología egipcia. ¿Quién es esta bestia?'],
    'alternativas': [['Khepri, el escarabajo del renacimiento.', 0], 
                     ['Bennu, el ave fénix de la creación.', 0], 
                     ['Apofis, una serpiente gigante que representa la oscuridad y el caos cósmico.', 1], 
                     ['Ammit, una criatura infernal que devoraba los corazones indignos.', 0]]},
